...
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./data/gsat-corpus-stats.json','./data/vocabulary-zh.json','./data/vocabulary-details.json','./icons/icon-192.png','./icons/icon-512.png'];
