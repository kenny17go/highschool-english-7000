const CACHE='hs7000-v1.4.3';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./data/gsat-corpus-stats.json','./data/vocabulary-zh.json','./icons/icon-192.png','./icons/icon-512.png'];
