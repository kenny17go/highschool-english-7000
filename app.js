...
let state=loadState();
function loadState(){const base={progress:{},mistakes:{},favorites:{},stats:{correct:0,total:0},settings:{dailyGoal:20,mode:'7000',autoSpeak:true},lastStudy:null,streak:0};try{const saved=JSON.parse(localStorage.getItem(STORAGE_KEY)||'{}');return {...base,...saved,progress:saved.progress||{},mistakes:saved.mistakes||{},favorites:saved.favorites||{},stats:{...base.stats,...(saved.stats||{})},settings:{...base.settings,...(saved.settings||{})}}}catch{return base}}
...
function detailFor(w){const e=ENRICH[w.word]||{};return {example:genericExample(w),collocations:genericCollocations(w),root:rootHint(w.word),syn:e.syn||[],ant:e.ant||[],conf:confusables(w)}}
